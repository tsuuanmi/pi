...
- `packages/workflows/src/tools/workflow-tools.ts` for workflow tool registration helpers and `packages/pi/src/package-manager/extensions/builtin-workflows.ts` for the Pi-owned extension entrypoint;

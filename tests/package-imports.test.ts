	...
	test("covers every package export", () => {
		expect(publicImportTargets().map((target) => `${target.packageName}${target.exportPath}`)).toMatchInlineSnapshot(`
			[
			  ...
			  "@tsuuanmi/pi-workflows./hooks",
			  "@tsuuanmi/pi-workflows./register",
			  "@tsuuanmi/pi-workflows./runtime/endpoint",
			  "@tsuuanmi/pi-workflows./runtime/fallback-commands",
			  "@tsuuanmi/pi-workflows./runtime/gc",
			  "@tsuuanmi/pi-workflows./runtime/lease",
			  "@tsuuanmi/pi-workflows./runtime/lifecycle",
			  "@tsuuanmi/pi-workflows./runtime/mutation",
			  "@tsuuanmi/pi-workflows./runtime/owner",
			  "@tsuuanmi/pi-workflows./runtime/preservation",
			  "@tsuuanmi/pi-workflows./runtime/receipt-rules",
			  "@tsuuanmi/pi-workflows./runtime/rpc",
			  "@tsuuanmi/pi-workflows./runtime/runner",
			  "@tsuuanmi/pi-workflows./runtime/seams",

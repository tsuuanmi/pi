...
import { highlightCode, initTheme } from "#coding-agent/theme/theme";
import { highlight, renderHighlightedHtml, supportsLanguage } from "#coding-agent/utils/terminal/syntax-highlight";

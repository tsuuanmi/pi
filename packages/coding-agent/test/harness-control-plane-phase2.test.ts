...
import { operate } from "../src/harness-control-plane/operate.ts";
import {
	...
	recoverPrimitive,
} from "../src/harness-control-plane/operations.ts";
import { preserveDirtyWorktree } from "../src/harness-control-plane/preserve.ts";
import type { HarnessRpc, RpcStateSnapshot } from "../src/harness-control-plane/rpc-adapter.ts";
import {
	readRuntimeReceipts,
	readSessionState,
	resolveHarnessRoot,
...
import {
	...
	validateVanish,
} from "../src/harness-control-plane/vanish.ts";

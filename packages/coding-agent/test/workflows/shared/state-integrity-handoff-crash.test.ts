...
import type { WorkflowTransactionJournal } from "../../../src/packages/workflows/runtime/shared/transaction-journal.ts";
import { writeWorkflowState } from "../../../src/packages/workflows/runtime/shared/workflow-state.ts";

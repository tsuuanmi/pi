...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@tsuuanmi/pi-coding-agent"><img alt="npm" src="https://img.shields.io/npm/v/@tsuuanmi/pi-coding-agent?style=flat-square" /></a>
</p>
<p align="center">
...
On startup, Pi checks for available package (extension) updates. Use `--offline` or `PI_OFFLINE=1` to disable all startup network operations, including package update checks.
...
```typescript
import { AuthStorage, createAgentSession, ModelRegistry, SessionManager } from "@tsuuanmi/pi-coding-agent";
...
- **Pi workflow + skills** - a `pi workflow` control plane plus the built-in `deep-interview`, `ralplan`, `team`, and `ultragoal` skills for planning and parallel execution. See [docs/workflow.md](docs/workflow.md).

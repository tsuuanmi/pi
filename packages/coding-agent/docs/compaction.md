...
- [`packages/coding-agent/src/core/session-manager.ts`](https://github.com/tsuuanmi/pi/blob/main/packages/coding-agent/src/core/session-manager.ts) - Entry types (`CompactionEntry`, `BranchSummaryEntry`)
...
Defined in [`session-manager.ts`](https://github.com/tsuuanmi/pi/blob/main/packages/coding-agent/src/core/session-manager.ts):
...
Extensions can intercept and customize both compaction and branch summarization. See [`extensions/types.ts`](https://github.com/tsuuanmi/pi/blob/main/packages/coding-agent/src/api/types.ts) for event type definitions.
...
```typescript
import { convertToLlm, serializeConversation } from "@tsuuanmi/pi-coding-agent";

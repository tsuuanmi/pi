...
**Source:** `src/packages/workflows/runtime/subagents/`
...
Both tools filter out `subagent_spawn` and other subagent tools from the spawned subagent's tool set, enforcing the nesting guard described in the [Subagents](../../../core/subagents/subagents.md) documentation.

## See Also

- [Subagents](../../../core/subagents/subagents.md) - Pi-native SubagentManager and seven subagent tools

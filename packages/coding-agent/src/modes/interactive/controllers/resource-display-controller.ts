...
export class ResourceDisplayController {
	...
	private readonly getSessionManager: () => AgentSession["sessionManager"];
	private readonly getOptionsVerbose: () => boolean | undefined;
	private readonly getToolOutputExpanded: () => boolean;
	private readonly getQuietStartup: () => boolean | undefined;
	...
	private get toolOutputExpanded(): boolean {
		return this.getToolOutputExpanded();
	}
	private get options(): { verbose: boolean | undefined } {
		return { verbose: this.getOptionsVerbose() };
	}
	private get settingsManager(): { getQuietStartup(): boolean | undefined } {
		return { getQuietStartup: () => this.getQuietStartup() };
	}

	constructor(opts: {
		chatContainer: Container;
		getSession: () => AgentSession;
		getSessionManager: () => AgentSession["sessionManager"];
		getOptionsVerbose: () => boolean | undefined;
		getToolOutputExpanded: () => boolean;
		getQuietStartup: () => boolean | undefined;
	}) {
		this.chatContainer = opts.chatContainer;
		this.getSession = opts.getSession;
		this.getSessionManager = opts.getSessionManager;
		this.getOptionsVerbose = opts.getOptionsVerbose;
		this.getToolOutputExpanded = opts.getToolOutputExpanded;
		this.getQuietStartup = opts.getQuietStartup;
	}

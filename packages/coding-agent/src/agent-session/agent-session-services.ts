...
import type { SessionStartEvent, ToolDefinition } from "#coding-agent/extensions/index";
...
} from "#coding-agent/skills/resource-loader";
import { SubagentManager } from "#coding-agent/subagents/subagents";

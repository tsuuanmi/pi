...
import { collectEntriesForBranchSummary, generateBranchSummary } from "#coding-agent/compaction/index";
import type { SessionBeforeTreeResult, TreePreparation } from "#coding-agent/extensions/index";
import type { BranchSummaryEntry } from "#coding-agent/session/session-manager";

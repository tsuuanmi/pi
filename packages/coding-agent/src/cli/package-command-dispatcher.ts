...
import { DefaultPackageManager, type ResolvedResource } from "#coding-agent/package-manager/package-manager";
...
import "#coding-agent/subagents/subagent-manager-factory-registration";

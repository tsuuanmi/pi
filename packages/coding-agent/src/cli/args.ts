...
import { APP_NAME, CONFIG_DIR_NAME, ENV_AGENT_DIR, ENV_SESSION_DIR } from "#coding-agent/config/config";
...
${chalk.bold("Commands:")}
  ...
  ${APP_NAME} mcp <verb>                Manage MCP servers (list/add/remove/test)
...
${chalk.bold("Environment Variables:")}
  ...
  PI_OFFLINE                       - Disable package network operations when set to 1/true/yes
`);
}

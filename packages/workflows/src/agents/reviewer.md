...
systemPrompt: |
  ...
  ```json
  {
    ...
    "files_reviewed": [
      { "path": "packages/workflows/src/skills/team/runtime.ts", "note": "Reviewed task transition gate." }
    ],
    "tests_reviewed": [
    ...
    "evidence": [
      { "kind": "file", "ref": "packages/workflows/src/skills/team/runtime.ts", "note": "reviewed" }
    ]
  }
  ```
---

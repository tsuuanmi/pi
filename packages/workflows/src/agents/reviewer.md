...
systemPrompt: |
  ...
  ```json
  {
    ...
    "files_reviewed": [
      { "path": "packages/workflows/src/skills/team/tasks.ts", "note": "Reviewed task transition gate." }
    ],
    "tests_reviewed": [
    ...
    "evidence": [
      { "kind": "file", "ref": "packages/workflows/src/skills/team/tasks.ts", "note": "reviewed" }
    ]
  }
  ```
---

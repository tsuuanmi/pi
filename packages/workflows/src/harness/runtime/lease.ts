...
import { removeSession, sessionPaths } from "#workflows/harness/runtime/storage";
 ...
 * `gc.ts`). NOTE: `removeSession` does not acquire the session-dir mutation lock, so this

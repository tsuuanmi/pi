...
2. `pi workflow deep-interview plan-question --input '{"sessionId":"<session-id>","round":1,"questionId":"q1","questionText":"..."}' --json` before asking each single user-facing question.

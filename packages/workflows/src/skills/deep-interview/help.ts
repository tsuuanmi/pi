...
export const DEEP_INTERVIEW_SKILL_HELP: WorkflowSkillHelp = {
	...
	actions: {
		"plan-question": {
			...
			example: `pi workflow deep-interview plan-question --input '{"sessionId":"<session-id>","round":1,"questionText":"..."}' --json`,
		},
		"record-answer": {
			...
			example: `pi workflow deep-interview record-answer --input '{"sessionId":"<session-id>","round":1,"customInput":"..."}' --json`,
		},
		"record-scoring": {

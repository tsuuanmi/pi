...
| `src/harness/shared/` | Shared artifacts, audit, compaction, orchestration, registry, session, and state utilities. Per-skill HUD builders live with their owning skill harnesses. | [harness/shared/shared.md](harness/shared/shared.md) |

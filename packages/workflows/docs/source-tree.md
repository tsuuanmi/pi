...
| `src/skills/deep-interview/` | Deep Interview `SKILL.md` plus canonical contracts, envelope parsing, persistence, question/round operations, transition validation, closure, spec finalization, policy, HUD, mutation guard, and tools. | [skills/deep-interview/index.md](skills/deep-interview/index.md) |
...
| `src/tool/` | Workflow context, host/spec contracts, model-visible result details, registration, and surface metadata. | [tool/details.md](tool/details.md), [subagents/subagents.md](subagents/subagents.md) |

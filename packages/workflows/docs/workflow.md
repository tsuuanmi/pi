...
Invoke a skill with `/skill:<name>` (e.g. `/skill:ralplan`). See [Skills](https://github.com/tsuuanmi/pi/tree/main/packages/pi/docs/skills/skills.md) for the skill format and installation paths.

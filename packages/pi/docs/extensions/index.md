...
Tools can provide `renderCall` and `renderResult` for custom TUI display. See [tui.md](../ui/tui.md) for the full component API and [tool-execution.ts](https://github.com/tsuuanmi/pi/blob/main/packages/pi/src/ui/interactive/components/tool-execution.ts) for how tool rows are composed.

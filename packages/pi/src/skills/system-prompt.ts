...
export interface BuildSystemPromptOptions {
	...
	customPrompt?: string;
	/** Tools to include in prompt. Default: [read, bash, edit, write, lsp] */
...
export function buildSystemPrompt(options: BuildSystemPromptOptions): string {
	...
	const tools = selectedTools || ["read", "bash", "edit", "write", "lsp"];
	...
	let prompt = `You are an expert coding assistant operating inside pi, an AI agent harness. You help users by reading files, executing commands, editing code, and writing new files.

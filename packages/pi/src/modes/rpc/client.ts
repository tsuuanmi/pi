/**
 * RPC Client for programmatic access to the AI agent.
 *
...
export interface RpcClientOptions {
	/** Path to the CLI entry point (default: searches for dist/cli/cli.js) */
	cliPath?: string;
...
export class RpcClient {
	...
	async start(): Promise<void> {
		...
		const cliPath = this.options.cliPath ?? "dist/cli/cli.js";
		const args = ["--mode", "rpc"];

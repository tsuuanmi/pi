/**
 * Shared test utilities for pi tests.
 */
...
import { createEventBus } from "#pi/package-manager/extensions/event-bus";
import type { Extension, ExtensionFactory, LoadExtensionsResult } from "#pi/package-manager/extensions/index";
import { createExtensionRuntime, loadExtensionFromFactory } from "#pi/package-manager/extensions/loader";

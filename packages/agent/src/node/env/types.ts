/**
 * Environment contracts for the Node.js execution environment.
 *
 * Provides filesystem and shell capability interfaces, result types, and
 * backend-independent error codes for NodeExecutionEnv and related utilities.
 */

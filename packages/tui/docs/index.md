...
- [Status Line](components/status-line/index.md) - `StatusLineComponent` (configurable multi-row rail with HUD and hook status), segments, presets, separators, context thresholds, and git utils.

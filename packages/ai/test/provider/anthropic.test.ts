...
import { loginAnthropic, refreshAnthropicToken } from "#ai/auth/oauth/anthropic/index";
...
import { streamAnthropic } from "#ai/provider/anthropic/index";
...

{
	...
	async function capturePayload(
		...
		const s = stream(payloadCaptureModel, makeContext(), {
			...options,
			apiKey: "fake-key",
			onPayload: (payload) => {
...

{
	...
	async function capturePayload(
		...
		const s = stream(payloadCaptureModel, makePayloadCaptureContext(), {
			...options,
			apiKey: "fake-key",
			onPayload: (payload) => {
				capturedPayload = payload as AnthropicThinkingPayload;

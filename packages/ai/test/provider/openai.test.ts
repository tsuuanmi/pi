import type { ResponseOutputMessage, ResponseStreamEvent } from "openai/resources/responses/responses.js";
import { afterEach, beforeEach, describe, expect, it, vi } from "vitest";
import { getModel } from "#ai/model/catalog";
import type { Model } from "#ai/model/index";
import type { Context } from "#ai/protocol/context";
import type { AssistantMessage, AssistantMessageEvent, Message } from "#ai/protocol/message";
import type { Usage } from "#ai/protocol/usage";
import { streamOpenAICompletions } from "#ai/provider/openai/completions/index";
import { convertResponsesMessages, processResponsesStream } from "#ai/provider/openai/responses/shared";
import { applyOpenAIServiceTierPricing, getOpenAIServiceTierCostMultiplier } from "#ai/provider/openai/stream-options";

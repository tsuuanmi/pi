...
export function getModelProviders(): KnownProviderId[] {
	return Array.from(modelRegistry.keys()) as KnownProviderId[];
}

export function getModels<TProvider extends KnownProviderId>(provider: TProvider): Model<Api>[] {

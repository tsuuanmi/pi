import type { AnthropicOptions } from "#ai/providers/anthropic/anthropic-provider";
import type { OpenAICodexResponsesOptions } from "#ai/providers/openai/codex-responses-api";
import type { OpenAICompletionsOptions } from "#ai/providers/openai/completions-api";
import type { OpenAIResponsesOptions } from "#ai/providers/openai/responses-api";
import { clearApiProviders, registerApiProvider } from "#ai/providers/provider-registry";
...
> {
	anthropicProviderModulePromise ||= import("#ai/providers/anthropic/anthropic-provider").then((module) => {
...
> {
	openAICodexResponsesProviderModulePromise ||= import("#ai/providers/openai/codex-responses-api").then((module) => {
...
> {
	openAICompletionsProviderModulePromise ||= import("#ai/providers/openai/completions-api").then((module) => {
...
> {
	openAIResponsesProviderModulePromise ||= import("#ai/providers/openai/responses-api").then((module) => {

...
import type { TextContent, TextSignatureV1, ThinkingContent, ToolCall } from "#ai/protocol/content";
import type { Context } from "#ai/protocol/context";
import type { Api } from "#ai/protocol/ids";
import type { AssistantMessage, StopReason } from "#ai/protocol/message";

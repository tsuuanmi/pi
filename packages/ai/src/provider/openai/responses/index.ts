...
import type { Model, OpenAIResponsesCompat, StreamFunction } from "#ai/model/index";
 ...
 */
const streamOpenAIResponsesWithProviderOptions: StreamFunction<"openai-responses", OpenAIResponsesOptions> = (
...
export const streamOpenAIResponses: StreamFunction<"openai-responses", StreamOptions> = (
	model: Model<"openai-responses">,
	context: Context,
	...
	return streamOpenAIResponsesWithProviderOptions(model, context, {
		...base,
		reasoningEffort,

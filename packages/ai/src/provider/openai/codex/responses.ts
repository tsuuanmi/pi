...
import { clampThinkingLevel } from "#ai/model/catalog";
...
} from "#ai/provider/openai/responses/shared";
import {
...
const streamOpenAICodexResponsesWithProviderOptions: StreamFunction<
...
export const streamOpenAICodexResponses: StreamFunction<"openai-codex-responses", StreamOptions> = (
	model: Model<"openai-codex-responses">,
	context: Context,
	...
	const requestedReasoning =
		options?.reasoning ?? (options?.reasoningEffort as StreamOptions["reasoning"] | undefined);
	const clampedReasoning = requestedReasoning ? clampThinkingLevel(model, requestedReasoning) : undefined;
	const reasoningEffort = clampedReasoning === "off" ? undefined : clampedReasoning;

	return streamOpenAICodexResponsesWithProviderOptions(model, context, {
		...base,
		reasoningEffort: reasoningEffort ?? (base.reasoningEffort as OpenAICodexResponsesOptions["reasoningEffort"]),

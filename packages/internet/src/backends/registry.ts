...
import { anthropicProviderName, registerAnthropicProviders } from "#internet/backends/anthropic/provider";
import type { InternetBackend } from "#internet/backends/backend";
import { googleProviderName, registerGoogleProviders } from "#internet/backends/google/provider";
import { providerName as openAiProviderName, registerOpenAiProviders } from "#internet/backends/openai/provider";

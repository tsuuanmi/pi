# providers/chatgpt-web/lifecycle/doctor

Mirrors `src/providers/chatgpt-web/lifecycle/doctor.ts`.
...
The implementation in `src/providers/chatgpt-web/lifecycle/doctor.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

# providers/chatgpt-web/content/markdown

Mirrors `src/providers/chatgpt-web/content/markdown.ts`.
...
The implementation in `src/providers/chatgpt-web/content/markdown.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

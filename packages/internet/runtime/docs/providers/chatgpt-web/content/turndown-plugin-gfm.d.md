# providers/chatgpt-web/content/turndown-plugin-gfm.d

Mirrors `src/providers/chatgpt-web/content/turndown-plugin-gfm.d.ts`.
...
The implementation in `src/providers/chatgpt-web/content/turndown-plugin-gfm.d.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

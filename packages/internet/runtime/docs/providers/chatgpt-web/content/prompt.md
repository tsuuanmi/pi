# providers/chatgpt-web/content/prompt

Mirrors `src/providers/chatgpt-web/content/prompt.ts`.
...
The implementation in `src/providers/chatgpt-web/content/prompt.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

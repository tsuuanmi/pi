# providers/chatgpt-web/transport/tunnel-service

Mirrors `src/providers/chatgpt-web/transport/tunnel-service.ts`.
...
The implementation in `src/providers/chatgpt-web/transport/tunnel-service.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

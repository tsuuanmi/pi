# providers/chatgpt-web/transport/tunnel

Mirrors `src/providers/chatgpt-web/transport/tunnel.ts`.
...
The implementation in `src/providers/chatgpt-web/transport/tunnel.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

# providers/chatgpt-web/adapter-error

Mirrors `src/providers/chatgpt-web/adapter-error.ts`.
...
The implementation in `src/providers/chatgpt-web/adapter-error.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

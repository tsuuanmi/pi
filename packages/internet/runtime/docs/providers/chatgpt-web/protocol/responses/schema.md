# providers/chatgpt-web/protocol/responses/schema

Mirrors `src/providers/chatgpt-web/protocol/responses/schema.ts`.
...
The implementation in `src/providers/chatgpt-web/protocol/responses/schema.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

# providers/chatgpt-web/tools/web-search/synthetic-tool

Mirrors `src/providers/chatgpt-web/tools/web-search/synthetic-tool.ts`.
...
The implementation in `src/providers/chatgpt-web/tools/web-search/synthetic-tool.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

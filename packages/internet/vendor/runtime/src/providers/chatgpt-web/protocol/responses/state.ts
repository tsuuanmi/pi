...
function schedulePersist(): void {
  ...
  // Resolve the target path now: tests may swap PI_INTERNET_RUNTIME_HOME before the
...
export function flushResponseState(): void {
  if (!persistTimer) return;
  // Use the path captured when the write was scheduled; PI_INTERNET_RUNTIME_HOME may have moved.

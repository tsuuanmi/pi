...
export function classifyError(status: number, type: string, message: string): RuntimeErrorPayload {
...
export function adapterFailureFromMessage(message: string): { httpStatus: number; error: RuntimeErrorPayload } {

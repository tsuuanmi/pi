# providers/chatgpt-web/protocol/responses/bridge

Mirrors `src/providers/chatgpt-web/protocol/responses/bridge.ts`.
...
The implementation in `src/providers/chatgpt-web/protocol/responses/bridge.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

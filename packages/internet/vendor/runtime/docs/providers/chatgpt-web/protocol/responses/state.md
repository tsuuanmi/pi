# providers/chatgpt-web/protocol/responses/state

Mirrors `src/providers/chatgpt-web/protocol/responses/state.ts`.
...
The implementation in `src/providers/chatgpt-web/protocol/responses/state.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

# providers/chatgpt-web/protocol/types

Mirrors `src/providers/chatgpt-web/protocol/types.ts`.
...
The implementation in `src/providers/chatgpt-web/protocol/types.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

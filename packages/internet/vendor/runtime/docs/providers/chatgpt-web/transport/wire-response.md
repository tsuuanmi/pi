# providers/chatgpt-web/transport/wire-response

Mirrors `src/providers/chatgpt-web/transport/wire-response.ts`.
...
The implementation in `src/providers/chatgpt-web/transport/wire-response.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

# providers/chatgpt-web/turn/adapter

Mirrors `src/providers/chatgpt-web/turn/adapter.ts`.
...
The implementation in `src/providers/chatgpt-web/turn/adapter.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

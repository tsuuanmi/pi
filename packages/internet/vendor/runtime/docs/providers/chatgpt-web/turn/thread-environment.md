# providers/chatgpt-web/turn/thread-environment

Mirrors `src/providers/chatgpt-web/turn/thread-environment.ts`.
...
The implementation in `src/providers/chatgpt-web/turn/thread-environment.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

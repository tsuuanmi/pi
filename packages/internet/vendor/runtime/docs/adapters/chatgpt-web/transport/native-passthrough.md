# adapters/chatgpt-web/transport/native-passthrough

Mirrors `src/adapters/chatgpt-web/transport/native-passthrough.ts`.
...
The implementation in `src/adapters/chatgpt-web/transport/native-passthrough.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

# adapters/chatgpt-web/transport/wire-capture

Mirrors `src/adapters/chatgpt-web/transport/wire-capture.ts`.
...
The implementation in `src/adapters/chatgpt-web/transport/wire-capture.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

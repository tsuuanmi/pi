# adapters/chatgpt-web/protocol/responses/reasoning-envelope

Mirrors `src/adapters/chatgpt-web/protocol/responses/reasoning-envelope.ts`.
...
The implementation in `src/adapters/chatgpt-web/protocol/responses/reasoning-envelope.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

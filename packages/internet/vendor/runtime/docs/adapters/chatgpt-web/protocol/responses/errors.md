# adapters/chatgpt-web/protocol/responses/errors

Mirrors `src/adapters/chatgpt-web/protocol/responses/errors.ts`.
...
The implementation in `src/adapters/chatgpt-web/protocol/responses/errors.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

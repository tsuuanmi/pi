# adapters/chatgpt-web/turn/execution

Mirrors `src/adapters/chatgpt-web/turn/execution.ts`.
...
The implementation in `src/adapters/chatgpt-web/turn/execution.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

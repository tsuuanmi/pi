# adapters/chatgpt-web/turn/environment

Mirrors `src/adapters/chatgpt-web/turn/environment.ts`.
...
The implementation in `src/adapters/chatgpt-web/turn/environment.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

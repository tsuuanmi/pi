# adapters/chatgpt-web/turn/broker

Mirrors `src/adapters/chatgpt-web/turn/broker.ts`.
...
The implementation in `src/adapters/chatgpt-web/turn/broker.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

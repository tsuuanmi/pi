# adapters/chatgpt-web/lifecycle/config

Mirrors `src/adapters/chatgpt-web/lifecycle/config.ts`.
...
The implementation in `src/adapters/chatgpt-web/lifecycle/config.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

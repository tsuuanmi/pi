# adapters/chatgpt-web/lifecycle/setup

Mirrors `src/adapters/chatgpt-web/lifecycle/setup.ts`.
...
The implementation in `src/adapters/chatgpt-web/lifecycle/setup.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

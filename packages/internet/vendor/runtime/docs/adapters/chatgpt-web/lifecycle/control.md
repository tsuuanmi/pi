# adapters/chatgpt-web/lifecycle/control

Mirrors `src/adapters/chatgpt-web/lifecycle/control.ts`.
...
The implementation in `src/adapters/chatgpt-web/lifecycle/control.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

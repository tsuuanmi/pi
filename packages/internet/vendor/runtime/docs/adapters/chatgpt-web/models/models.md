# adapters/chatgpt-web/models/models

Mirrors `src/adapters/chatgpt-web/models/models.ts`.
...
| `CHATGPT_WEB_LUNA_BACKEND_MODEL` | const — Exported constant, schema, selector, or protocol marker. | 3 |
...
| `CHATGPT_WEB_LUNA_CONTEXT_WINDOW` | const — Exported constant, schema, selector, or protocol marker. | 43 |
...
| `CHATGPT_WEB_LUNA_MODEL_ROUTE` | const — Exported constant, schema, selector, or protocol marker. | 155 |
...
The implementation in `src/adapters/chatgpt-web/models/models.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

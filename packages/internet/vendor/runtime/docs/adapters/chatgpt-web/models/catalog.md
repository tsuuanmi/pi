# adapters/chatgpt-web/models/catalog

Mirrors `src/adapters/chatgpt-web/models/catalog.ts`.
...
The implementation in `src/adapters/chatgpt-web/models/catalog.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

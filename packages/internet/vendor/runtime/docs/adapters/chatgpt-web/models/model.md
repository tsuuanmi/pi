# adapters/chatgpt-web/models/model

Mirrors `src/adapters/chatgpt-web/models/model.ts`.
...
The implementation in `src/adapters/chatgpt-web/models/model.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

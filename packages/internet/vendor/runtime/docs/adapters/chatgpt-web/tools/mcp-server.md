# adapters/chatgpt-web/tools/mcp-server

Mirrors `src/adapters/chatgpt-web/tools/mcp-server.ts`.
...
The implementation in `src/adapters/chatgpt-web/tools/mcp-server.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

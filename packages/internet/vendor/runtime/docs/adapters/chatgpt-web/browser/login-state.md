# adapters/chatgpt-web/browser/login-state

Mirrors `src/adapters/chatgpt-web/browser/login-state.ts`.
...
The implementation in `src/adapters/chatgpt-web/browser/login-state.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.

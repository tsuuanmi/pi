# adapters/chatgpt-web/content/image

Mirrors `src/adapters/chatgpt-web/content/image.ts`.
...
The implementation in `src/adapters/chatgpt-web/content/image.ts` is authoritative. Update this page when its exported API, data flow, or safety behavior changes.
